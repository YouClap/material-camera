...
abstract class BaseCameraFragment extends Fragment
        implements CameraUriInterface, View.OnClickListener, View.OnLongClickListener, View.OnTouchListener{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int primaryColor = getResources().getColor(R.color.transparent);
