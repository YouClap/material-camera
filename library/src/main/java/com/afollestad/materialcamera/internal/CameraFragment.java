...
import com.afollestad.materialcamera.util.DoubleClickListener;
import com.afollestad.materialcamera.util.FlipCameraCallback;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
    ...
    private FlipCameraCallback flipCameraCallback;
    ...
    private void createPreview() {
        ...
        mPreviewView.setOnClickListener(new DoubleClickListener() {
            @Override
            ...
            public void onDoubleClick(View v) {
                CameraFragment.super.flipCamera();
            }
        });
    }
